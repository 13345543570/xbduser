...
<div class="panel admin-panel">
  ...
  <form method="get" action="<?php echo U('Image/index');?>" enctype="multipart/form-data">
      ...
      <?php if(is_array($data)): foreach($data as $key=>$val): ?><tr>
          ...
          <td>
            <div class="button-group"><a class="button border-main"
                                         href="<?php echo U('Image/doup',array('id'=>$val['id']));?>"><span
                    class="icon-edit"></span> 修改</a> <a class="button border-red"
                                                        href="javascript:void(0)"
                                                        onclick="return del(<?php echo ($val["id"]); ?>,'Image')"><span
